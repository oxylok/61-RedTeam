# Humanize Behaviour V3 Challenge - Miner

This is miner bot script repo for the Humanize Behaviour v3 Challenge. This is sandboxed sample code for the challenge, you can use this code to test your bot script.
...
git clone https://github.com/RedTeamSubnet/RedTeam.git && \
    cd RedTeam/redteam_core/miner/commits/humanize_behaviour_v3
```
