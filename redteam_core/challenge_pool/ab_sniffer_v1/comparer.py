        ...
        for (
            ...
            for log in comparison_logs:
                ...
                try:
                    ...
                    log.miner_output["detection_js"] = None
                    log.reference_output["detection_js"] = None
            ...
            for other_log in other_commit.scoring_logs:
                ...
                if other_log.input_hash in miner_logs_by_hash:
                    ...
                    try:
                        ...
                        if not miner_log.miner_output:
                            bt.logging.warning(
                                f"[COMPARER - ABSComparer] miner_output is None for miner {miner_commit.miner_uid}"
                            )
